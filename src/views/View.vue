<template>
  <div :style="{background:getBackground, height: innerSize.height + 'px'}" @contextmenu="handleContextMenu">
    <v-slides-view :slides="sortLayout" :height="innerSize.height" />
  </div>
...
export default {
  ...
  setup() {
    ...
    const options = [
      { label: "编辑模式", key: "edit" },
      { label: "放映模式", key: "play" },
      { label: "浏览模式", key: "view", disabled: true },
      { label: "文稿模式", key: "doc" },
